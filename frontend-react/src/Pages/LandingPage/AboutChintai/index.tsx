  ...
  render() {
    return (
      <AboutContent>
        ...
        <DefiContentBox>
          <h1>{this.props.stores!.langStore.safeGetLocalizedString("aboutChintai.defi.title")}</h1>
          <p>{this.props.stores!.langStore.safeGetLocalizedString("aboutChintai.defi.content.p1")}</p>
          <p>{this.props.stores!.langStore.safeGetLocalizedString("aboutChintai.defi.content.p2")}</p>
        </DefiContentBox>
      </AboutContent>
    )
  }
