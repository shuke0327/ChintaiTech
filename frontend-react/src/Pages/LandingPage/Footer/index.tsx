      ...
      <FooterContainer>
        <ContainerInner>
          <FooterRow>
            ...
            <SectionContainer>
              ...
              <SubscribeOuter>
                ...
                />
                <span>
                  <img src={arrowImg} onClick={() => this.props.stores!.appStore.submitSubscribeRequest()} />
                </span>
                {/* <SubscribeButtonContainer>
                  <SubscribeButton onClick={() => this.props.stores!.appStore.submitSubscribeRequest()}>{this.props.stores!.langStore.safeGetLocalizedString("footer.subscribe")}
                  </SubscribeButton>
                </SubscribeButtonContainer> */}
              </SubscribeOuter>
            </SectionContainer>
          ...
          <CopyrightText>
            ...
            <CopyrightRowItem>
              <a href={"https://drive.google.com/a/chintai.io/file/d/1M9foaaM-2SQpFfJ0iyriqJ3xpIODPPOz/view?usp=sharing"}>{this.props.stores!.langStore.safeGetLocalizedString("footer.terms")}</a>
            </CopyrightRowItem>
          </CopyrightText>
        </ContainerInner>
      </FooterContainer>
