          ...
          <IslandContent>
            <SpacedRow>
              <NavRow>
                ...
                <Link to={"/kylin/auction/bid"}>
                  <NavButton isActive={this.props.activeView === "bid"}>
                    <FaCoins />
                    <h3>Get {this.props.stores!.projectsStore.projectDetails.symbol}</h3>
                    <ActiveIndicator isActive={this.props.activeView === "bid"} />
                  </NavButton>
                </Link>

                <Link to={"/kylin/auction/kyc"}>
                ...
                <Link to={"/kylin/auction/contributions"}>
                ...
                <Link to={"/kylin/auction/referral"}>
