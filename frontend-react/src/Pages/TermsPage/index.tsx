...
export const getTosContent = () => (
  <TermsContainer>
    <h1>CHEX TOKEN SALE TERMS AND CONDITIONS</h1>
    ...
    <p>
      ...
      SECURITIES IN ANY JURISDICTION. THIS DOCUMENT DESCRIBES THE CHEX TOKEN
      SALE TERMS AND CONDITIONS.
                </p>
    <p>
      The following CHEX ​<b>Terms and Conditions</b> (the <b>"Agreement​"</b> or <b>"​Terms and Conditions​"</b>)
...
purchase cryptographic tokens called "CHEX" as generated and sold by the Company, and the
explicit usage of the CHEX token. You and the Company are within this Agreement referred to
    ...
    <ol>
      <li>
        ...
        <ol>
          ...
          <li>
            <b>"CHEX smart contract"</b> means the “CHEX token contract” functionality and
            associated EOS account and public addresses which is used by Chintai for the
            functionality for the CHEX auction and distribution of CHEX Tokens.
                      </li>
          <li>
            <b>"Cycle​"</b> – means each 18 hour period where CHEX tokens will be distributed. Each
            cycle disperses 1,875,000 CHEX, across 320 cycles and 240 days.
                      </li>
          <li>
            <b>"CHEX Distribution/Allocation Period"</b> - refers to the length of time, and all
technical processes required to distribute/allocate CHEX to the Purchaser.
                      </li>
          <li>
...
Company.
      ...
      <li>
        <b>CHEX TOKENS PURCHASE</b>
        <p>PURCHASER AGREES TO BUY, AND COMPANY AGREES TO DISTRIBUTE, THE CHEX
  TOKENS IN ACCORDANCE WITH THE FOLLOWING TERMS.</p>
        <p><b>Conditions to CHEX token sale</b></p>
...
restricted. See Annex B for definition of U.S. person.</p>
        <p><b>No U.S. OR Chinese Purchasers​:</b> CHEX Tokens are not being offered or distributed to
...
in or under the laws of the People’s Republic of China (a “Chinese person”).</p>
        ...
        purchase CHEX Tokens. CHEX tokens are not being offered or distributed to U.S. or
Chinese persons.</p>
        <p>When you purchase, or otherwise receive, a CHEX token, you may only do so by
...
regarding whether CHEX is a suitable investment for you;</li>
...
and Ether, as well as blockchain-based software systems generally;</li>
          <li>you are legally permitted to receive and hold and make use of CHEX in your and any
other relevant jurisdiction;</li>
          <li>you will supply the KYC Provider with all information, documentation or copy
          documentation required in order to allow us to accept your purchase of CHEX and
allocate CHEX to you;</li>
          <li>you have not supplied the KYC Provider with information relating to Purchaser origin of
funds for the acquisition of CHEX tokens or otherwise which is inaccurate or misleading;</li>
...
obligations, including but not limited to any anti-money laundering obligation;</li>
          ...
          <li>you are of a sufficient age (if an individual) to legally obtain CHEX tokens, and you are
not aware of any other legal reason to prevent you from obtaining CHEX tokens;</li>
          <li>you take sole responsibility for any restrictions and risks associated with receiving and
holding CHEX tokens, including but not limited to terms outlined in Annex A;</li>
          <li>by acquiring CHEX tokens, you are not making a regulated investment, as this term may
be interpreted by the regulator in your jurisdiction;</li>
          <li>you are not obtaining or using CHEX tokens for any illegal purpose, and will not use
CHEX tokens for any illegal purpose;</li>
          <li>you waive any right you may have to participate in a class action lawsuit or a class wide
          arbitration against any entity or individual involved with the sale of CHEX, including The
Company & CHINTAI Team;</li>
          <li>your acquisition of CHEX tokens does not involve your purchase or receipt of shares,
...
CHEX tokens or Chintai;</li>
          <li>the CHEX token is a utility token and is to be purchased, handled and used as such.
          CHEX tokens are intended to be a multi-purpose utility token for the Chintai platform
          only, and entail no other rights, uses, purpose, attributes, functionalities or features,express or implied. Although CHEX tokens are transferable and may be tradable, they
...
commodity or any other kind of financial instrument;</li>
          <li>
            ...
            allocation, use or ownership of CHEX tokens (ii) the potential appreciation or
            depreciation in the value of CHEX tokens over time, if any, (iii) the sale and purchase of
            CHEX tokens; and/or (iv) any other action or transaction related to CHEX tokens has tax
            implications.
</li>
        </ul>
      </li>
      <li>
        ...
        <p>Do not purchase CHEX tokens if you are not an expert in dealing with cryptographic
tokens and blockchain-based software systems. Prior to purchasing CHEX tokens, you
...
purchase chex.</p>
        <p>Purchases of CHEX tokens should be undertaken only by individuals, entities, or
        ...
        Company will be available to assist purchasers of CHEX tokens during the sale, the
        Company will not be responsible in any way for loss of BTC, ETH, EOS, or CHEX tokens
resulting from actions taken by, or omitted by Purchasers.</p>
        <p>If you do not have such experience or expertise, then you should not purchase CHEX
        tokens or participate in the distribution of CHEX tokens. Your acceptance of this
        Agreement, and participation in the CHEX token sale is deemed to be your undertaking
that you satisfy the requirements mentioned in this paragraph.</p>
      </li>
      <li>
        <b>CHEX TOKEN DISTRIBUTION</b>
        <p>CHEX Tokens are intended to be a multi-purpose utility token for the Chintai platform
(as defined in the token economic white paper (the "White Paper​") provided at
https://www.chintai.io (the “​ Website​ ”) as of the date the Purchaser acquires CHEX
tokens).</p>
        <p>The right to alter the length of the CHEX Distribution/Allocation Period is explicitly
        reserved by the Company to include, without limitation, bugs in the CHEX smart
contract, unavailability of the CHEX website, or any other operational or security issue.</p>
        ...
        securing cryptographic tokens to receive any CHEX tokens that are purchased by the
        Purchaser. The Purchaser understands that the CHEX smart contract will distribute the
        tokens automatically, and that the CHEX smart contract is protected and designed to
achieve the following:</p>
        <ul>
          <li>The Purchaser acknowledges that the CHEX smart contract ONLY directly
accepts EOS tokens.</li>
          <li>The Purchaser acknowledge that they have read, and fully understand that the
          CHEX smart contract distributes CHEX tokens on the basis of the hard coded
          mechanisms of the CHEX smart contract. Relevant amounts of CHEX tokens will
          be transferred to the Purchaser’s EOS account, based upon the amount of EOS
          tokens sent to the CHEX smart contract in the current cycle, and total demand
in the current cycle.</li>
          <li>
            ...
            in permanently losing any CHEX tokens purchased. CHINTAI Ltd is not legally
            liable, nor responsible in any other form, including refunds, for Purchasers who
            buy CHEX with an account other than an EOS Account.
</li>
          <li>
            The CHEX token distribution represents 60% of total supply at issuance, which
...
1,875,000 million CHEX tokens per cycle (<b>“Distribution Actuation”</b>).
</li>
          <li>
            The total amount of CHEX tokens distributed to The Purchaser in a Cycle is
            ...
            of CHEX Tokens set forth above will be distributed pro rata amongst all
            authorized purchasers, based on the total EOS contributed during those periods,
            respectively, as follows:
<p>Number of CHEX Tokens distributed to an authorized purchaser = (A / C) * B</p>
            Where:
<ul>
              <li>A = Total EOS contributed by an authorized purchaser during the
period.</li>
              <li>B = Total number of CHEX Tokens available for distribution in the
period.</li>
              <li>C = Total EOS contributed by all authorized purchasers during the
period.</li>
            </ul>
          </li>
          <li>The Purchaser understands that the number of CHEX tokens that the Purchaser
has received in a particular cycle of CHEX Tokens may vary.</li>
          <li>The Purchaser understands that transfers of any form to the CHEX smart
          contract are non-refundable, and cannot be reversed. After buying CHEX tokens,
          ...
          CHEX smart contract, whether or not the Company has withdrawn EOS held in
          the CHEX smart contract. To further punctuate this point, and illustrate the
          rights of the Company, the Purchaser understands that the Company can
          remove EOS held in the CHEX smart contract at the end of every Cycle, or
whenever the Company deems appropriate.</li>
          <li>Purchase of CHEX tokens at a Cycle shall be subject to a minimum transfer by
purchaser of 1 EOS.</li>
          <li>The utility rights connected to CHEX tokens are subject to the limitations
          ...
          Company reserves the right to circumvent the CHEX smart matching algorithm
          ...
          CHEX tokens from a regulatory or legal perspective. The Company shall have
          the right to sell any such underlying assets (if already part of CHEX portfolio)
and block their acquisition.</li>
          <li>Ownership of CHEX tokens during the CHEX token sale carries no rights express
or implied. Purchases of CHEX are non-refundable.</li>
          <li>Under no circumstances should CHEX tokens be considered an investment
          opportunity. CHEX tokens are not designed for financial investment, nor does
          the Company consider distribution of CHEX tokens for any type of financial
          investor to make monetary gains. Purchasers that accumulate CHEX tokens by
          sending EOS to the CHEX smart contract acknowledge that they are not buyingCHEX with the intention of investment purposes in order to receive financial, or
any other form of capital gain.</li>
          <li>The maximum supply of CHEX will be​ <b>1 billion tokens</b>.</li>
          <li>The distribution of the CHEX tokens is as follows:
  <ul>
          ...
          Contract can send back CHEX Tokens and/or EOS tokens to (i.e. not an address
of a token exchange like Poloniex, Coinbase, Bitfinex, etc).</p>
          </li>
        </ul>
        <b>After the CHEX Token Sale</b>
        <p>CHEX TOKENS HAVE NO VOTING RIGHTS, CONSEQUENTLY PURCHASERS SHOULD
HAVE NO EXPECTATION OF ANY INFLUENCE OVER GOVERNANCE OF THE
COMPANY.</p>
        <b>All purchases of CHEX are final</b>
        <p>ALL PURCHASES OF CHEX ARE FINAL. PURCHASES OF CHEX ARE
        NON-REFUNDABLE. BY PURCHASING CHEX, THE PURCHASER ACKNOWLEDGES
...
SHAREHOLDERS ARE REQUIRED TO PROVIDE A REFUND FOR ANY REASON.</p>
        ...
        ENTITIES OWNING CHEX CREATES MATERIAL REGULATORY OR OTHER LEGAL
        RISKS OR ADVERSE EFFECTS FOR THE COMPANY AND/OR CHEX, THE COMPANY
        RESERVES THE RIGHT TO: (A) BUY ALL CHEX FROM SUCH CHEX OWNERS AT THE
...
OF THE COMPANY.</p>
      ...
      <li>
        ...
        <p>THE PURCHASER EXPRESSLY AGREES THAT THE PURCHASER IS PURCHASING CHEX
TOKENS AT THE PURCHASER SOLE RISK AND THAT CHEX TOKENS PROVIDED ONAN "AS IS" BASIS WITHOUT WARRANTIES OF ANY KIND, EITHER EXPRESS OR
...
PURCHASING CHEX WILL BE UNINTERRUPTED OR ERROR-FREE.</p>
      </li>
      <li>
...
OR RELATED TO (i) USE OF, OR INABILITY TO USE, CHEX TOKENS OR (ii) THE
...
PURCHASE CHEX TOKENS, OR ARISING OUT OF ANY INTERACTION WITH THE
SMART CONTRACT IMPLEMENTED IN RELATION TO CHEX. THE PURCHASER
FURTHER SPECIFICALLY ACKNOWLEDGES THAT THE CHINTAI TEAM IS NOT LIABLE
FOR THE CONDUCT OF THIRD PARTIES, INCLUDING OTHER PURCHASERS OF CHEX,
AND THAT THE RISK OF PURCHASING AND USING CHEX TOKENS RESTS ENTIRELY
...
COMPANY FOR THE PURCHASE OF CHEX. SOME JURISDICTIONS DO NOT ALLOW
...
modification of these Terms nor be legally binding.</p>
      ...
      <li><b>TAXATION RELATED TO THE TOKEN SALE</b>
        <p>The Purchaser bears the sole responsibility to determine if the purchase of CHEX
tokens with EOS or the potential appreciation or depreciation in the value of CHEX
tokens over time has tax implications for the Purchaser in the Purchaser's home
jurisdiction. By purchasing CHEX tokens, and to the extent permitted by law, the
...
CHEX tokens.</p></li>
      ...
      accepted such changes by purchasing CHEX tokens. The Terms and Conditions may
...
purchase or use of CHEX; (ii) your responsibilities or obligations under these Terms; (iii)
...
vault or other storage mechanism you use to receive and hold CHEX tokens purchased
...
are lost, you may lose access to your CHEX tokens. The Company is not responsible for
...
outside of arbitration, or on behalf of any other individual or group of individuals.</p>
    ...
    <p><b>ANNEX A</b></p>
    <p><b>CHEX Risks</b></p>
    <p>By purchasing, owning, and using CHEX, you expressly acknowledge and assume the following
risks:</p>
    <ol>
      <li><b>Risk​ ​ of​ ​ Losing​ ​ Access​ ​ to​ ​ CHEX​ ​ Due​ ​ to​ ​ Loss​ ​ of​ ​ Private​ ​ Key(s),​ ​ Custodial​ ​ Error​ ​ or
urchaser Error</b>
        <p>A private key, or a combination of private keys, is necessary to control and dispose of CHEX
        stored in your digital wallet or vault. Accordingly, loss of requisite private key(s) associated with
        your digital wallet or vault storing CHEX will result in loss of such CHEX. Moreover, any third
        party that gains access to such private key(s), including by gaining access to login credentials
        of a hosted wallet service you use, may be able to misappropriate your CHEX. Any errors or
        malfunctions caused by or otherwise related to the digital wallet or vault you choose to receiveand store CHEX in, including your own failure to properly maintain or use such digital wallet or
        vault, may also result in the loss of your CHEX. Additionally, your failure to follow precisely the
        procedures set forth in for buying and receiving Tokens, including, for instance, if you provide
        the wrong address for the receiving CHEX, or provides an address that is not EOS compatible,
may result in the loss of your Tokens.</p></li>
      <li>
        <b>Risks​ ​ Associated​ ​ with​ ​ the​ ​ EOS​ ​ Protocol & CHEX Auction.</b>
        <p>Because CHEX and the CHINTAI platform are based on the EOS protocol, any malfunction,
      breakdown or abandonment of the EOS protocol may have a material adverse effect on the
      platform or CHEX auction itself. Moreover, advances in cryptography, or technical advances
      such as the development of quantum computing, could present risks to the CHEX token and
      the platform, including the utility of the CHEX for obtaining services, by rendering ineffective
...
or CHEX in a variety of ways, including, but not limited to, malware attacks, denial of service
...
infrastructure of the platform, which could negatively affect the platform and CHEX, including
the utility of CHEX for obtaining services.</p>
      </li>
      <li>
        <b>Risks​ ​ Associated​ ​ with​ ​ Markets​ ​ for​ ​ CHEX</b>
...
exchange value to CHEX (e.g., as denominated in a digital or fiat currency), such value may be
extremely volatile.</p>
      </li>
      <li>
        <b>Risk​ of​​ Uninsured​ Losses</b>
        <p>Unlike bank accounts or accounts at some other financial institutions, CHEX are uninsured
...
recourse to you.</p>
      ...
      <li>
        ...
        <p>
          The regulatory status of CHEX and distributed ledger technology is unclear or unsettled in
...
platform and CHEX. It is likewise difficult to predict how or whether legislatures or regulatory
agencies may implement changes to law and regulation affecting distributed ledger
technology and its applications, including the platform and CHEX. Regulatory actions could
negatively impact the platform and CHEX in various ways, including, for purposes of illustration
only, through a determination that the purchase, sale and delivery of CHEX constitutes
unlawful activity or that CHEX are a regulated instrument that require registration or licensing
...
jurisdiction.
      ...
      <li>
        ...
        <p>The tax characterization of CHEX is uncertain. You must seek your own tax advice in
connection with purchasing CHEX, which may result in adverse tax consequences to you,
including withholding taxes, income taxes and tax reporting requirements.</p>
      ...
      <li>
        ...
        <p>Because CHEX confer no governance rights of any kind with respect to the CHINTAI platform
...
adversely affect the platform and the utility of any CHEX you own, including their utility for
obtaining services.</p>
      </li>
      <li><b>Unanticipated​ ​ Risks</b>
        <p>Cryptographic tokens such as CHEX are a new and untested technology. In addition to the risks
included in this Annex A of these Terms, there are other risks associated with your purchase,
possession and use of CHEX, including unanticipated risks. Such risks may further materialize
...
shall not be deemed “U.S. Persons.</li>
    ...
    <p>IF YOU DO NOT AGREE TO THESE TERMS, DO NOT PURCHASE CHEX FROM
THE COMPANY. BY PURCHASING CHEX FROM THE COMPANY, YOU WILL BE
