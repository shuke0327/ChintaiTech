      ...
      this.props.stores!.appStore.allRoundsSummaryUnfiltered.map((e) => {
        ...
        return (
          <TrWithOpacity key={e.roundNum} futureRound={e.roundNum > this.props.stores!.appStore.currentRoundNumber}>
            <td>{e.roundNum}</td>
            <td>
              <div><b>{e.chexPrice !== null ? moment.utc(e.endTime || 0).format("MM/DD/YYYY") : "--"}</b></div>
            ...
            <td>
              <Number>{e.chexPrice !== null ? commaNum(this.props.stores!.appStore.chexIssuedPerRound.toFixed(2)) : "0.00"}</Number>
              <div>{this.props.stores!.projectsStore.projectDetails.symbol}</div>
            </td>
            <td>
              <Number>~ {e.chexPrice !== null ? parseFloat(e.chexPrice).toFixed(8) : "--"}</Number>
            ...
            <table>
              <thead>
                <tr>
                  ...
                  <th>
                    <SmallContentTitle>{this.props.stores!.projectsStore.projectDetails.symbol} Issued</SmallContentTitle>
                  </th>
                  <th>
