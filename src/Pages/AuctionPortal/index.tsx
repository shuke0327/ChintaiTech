...
const Body = styled(FlexColumn)`
  ...
  overflow: hidden;
  background: radial-gradient(80% 70% at 75%, #e3ecf9 0%, #b1c5e090 100%);
  align-items: center;
  z-index: 1;
`
...
const DashboardGrid = styled.div`
  ...
  grid-template-rows: ${(props: { shouldShowKycWarning: boolean }) => props.shouldShowKycWarning ? "fit-content(1px) fit-content(1px) 88px 242px 320px" : "fit-content(1px) 88px 242px 320px"};
  ...
  ${(props: { activeView: string, shouldShowKycWarning: boolean }) => props.activeView === EAuctionPortalViews.kyc && `
    grid-template-rows: ${props.shouldShowKycWarning ? "fit-content(1px) fit-content(1px) fit-content(1px)" : "fit-content(1px) fit-content(1px)"};
    grid-template-areas:"navBar navBar"
  ...
  ${(props: { activeView: string, shouldShowKycWarning: boolean, tosConfirmed: boolean }) => props.activeView === EAuctionPortalViews.getChex && props.tosConfirmed && `
    grid-template-rows: ${props.shouldShowKycWarning ? "fit-content(1px) fit-content(1px) 88px 242px 106px fit-content(1px)" : "fit-content(1px) 88px fit-content(1px) 106px fit-content(1px)"};
    grid-template-areas:"navBar navBar"
                        ${props.shouldShowKycWarning ? "\"headWarning headWarning\"" : ""}
  ...
  @media( max-width: 830px) {
    ...
    grid-template-rows: ${(props: { shouldShowKycWarning: boolean }) => props.shouldShowKycWarning ? "fit-content(1px) fit-content(1px) fit-content(1px) fit-content(1px) 350px 350px" : "fit-content(1px) fit-content(1px) fit-content(1px) 350px 350px"};
    ...
    `}
      ...
      /* 6. Get CHEX view after they have accepted the TOS */
      ${(props: { activeView: string, shouldShowKycWarning: boolean, tosConfirmed: boolean }) => props.activeView === EAuctionPortalViews.getChex && props.tosConfirmed && `
      grid-template-rows: ${props.shouldShowKycWarning ? "fit-content(1px) fit-content(1px) fit-content(1px) fit-content(1px) fit-content(1px) fit-content(1px) fit-content(1px)" : "fit-content(1px) fit-content(1px) fit-content(1px) fit-content(1px) fit-content(1px) fit-content(1px)"};
      grid-template-areas:"navBar"
                          ${props.shouldShowKycWarning ? "\"headWarning\"" : ""}
                          "roundStats"
                          "countdown"
