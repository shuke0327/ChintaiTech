            ...
            <SummaryRow>
              ...
              <FlexColumn>
                <SmallContentTitleTooltip data-tip={this.props.stores!.langStore.safeGetLocalizedString("myContributions.chexReceivedTooltip")} data-place={"top"}>
                  {this.props.stores!.langStore.safeGetLocalizedString("myContributions.chexReceived")}
                  <ToolTip />
                </SmallContentTitleTooltip>
              ...
              <table>
                <thead>
                  <tr>
                    ...
                    <th>
                      <SmallContentTitle>{this.props.stores!.langStore.safeGetLocalizedString("myContributions.chex")}</SmallContentTitle>
                    </th>
                    <th>
                      <SmallContentTitle>{this.props.stores!.langStore.safeGetLocalizedString("myContributions.chexPrice")}</SmallContentTitle>
                    </th>
                    <th>
